...
public class ReceiveFileBrowserAdapter extends BaseAdapter
{
  ...
  public ReceiveFileBrowserAdapter(Context context,List<FileName> filePaths)
  {
  ...
  {
	  View fileView = mInflater.inflate(R.layout.receive_file_browser_item, null);
	  fileView.setTag(Integer.valueOf(position));
	  ImageView fileIcon = (ImageView)fileView.findViewById(R.id.imvFileIcon);
	  TextView fileName = (TextView)fileView.findViewById(R.id.txtFileName);
	  TextView fileSize = (TextView)fileView.findViewById(R.id.txtFileSize);
